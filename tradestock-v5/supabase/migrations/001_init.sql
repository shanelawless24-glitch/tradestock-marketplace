...
-- Note: This creates the profile and admin entries. You'll need to create the auth user separately
...
-- Note: After creating the auth user, run 002_admin_table.sql to create the admins table
